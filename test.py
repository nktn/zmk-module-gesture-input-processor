...
TEST_BUILD_DIR_NAME = "tests-zmk-module-gesture-input-processor"
...
class WestCommandsTests(unittest.TestCase):
    ...
    def test_zmk_build(self):
        self._test_zmk_build(
            {
                "module_gesture_board_feature_disabled": ConfigAndDeviceTree(
                    config=[
                        'CONFIG_ZMK_KEYBOARD_NAME="Module Test"',
                        "CONFIG_ZMK_USB=y",
                        "CONFIG_ZMK_BLE=y",
                        "# CONFIG_ZMK_GESTURE_INPUT_PROCESSOR is not set",
                    ],
                    device=[
                ...
                "module_gesture_board_without_rpc": ConfigAndDeviceTree(
                    config=[
                        "CONFIG_ZMK_GESTURE_INPUT_PROCESSOR=y",
                        "# CONFIG_ZMK_STUDIO is not set",
                        NotFound("CONFIG_ZMK_GESTURE_INPUT_PROCESSOR_STUDIO_RPC"),
                    ],
                    device=[
                        "DT_COMPAT_HAS_OKAY_zmk_input_processor_gesture",
                    ],
